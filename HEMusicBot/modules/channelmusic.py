...
from HEMusicBot.modules.play import generate_cover
from HEMusicBot.modules.play import arq
from HEMusicBot.modules.play import cb_admin_check
from HEMusicBot.modules.play import transcode
from HEMusicBot.modules.play import convert_seconds
from HEMusicBot.modules.play import time_to_seconds
from HEMusicBot.modules.play import changeImageSize
from HEMusicBot.config import BOT_NAME as bn
from HEMusicBot.config import DURATION_LIMIT
from HEMusicBot.config import UPDATES_CHANNEL as updateschannel
from HEMusicBot.config import que
from HEMusicBot.function.admins import admins as a
from HEMusicBot.helpers.errors import DurationLimitError
from HEMusicBot.helpers.decorators import errors
from HEMusicBot.helpers.admins import get_administrators
from HEMusicBot.helpers.channelmusic import get_chat_id
from HEMusicBot.helpers.decorators import authorized_users_only
from HEMusicBot.helpers.filters import command, other_filters
from HEMusicBot.helpers.gets import get_file_name
from HEMusicBot.services.callsmusic import callsmusic, queues
from HEMusicBot.services.callsmusic.callsmusic import client as USER
from HEMusicBot.services.converter.converter import convert
from HEMusicBot.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Tg_Group_Music_Vc_V2_Bot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
